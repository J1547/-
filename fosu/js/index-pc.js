$(function(){
   ...
   */
  tab({
    $tabX: $('.column-headline-box .column-top>h3'),
    $tabY: $('.column-headline-box .column-main>div'),
    autoPlay: false,
    hasMore: false
  });

  tab({
    $tabX: $('.column-new-box .column-top>h3'),
    $tabY: $('.column-new-box .column-main>ul'),
    autoPlay: true,
    timeout: 6800,
    hasMore: true,
    moreSelec:'.column-new-box .column-more',
    moreList:[window.base_url+'/school-news', window.base_url+'/xueyuan-news', window.base_url+'/academic-forecast']
  });

  // tab({
  //   $tabX: $('.column-msg-box .column-top>h3'),
  //   $tabY: $('.column-msg-box .column-main>ul'),
  //   hasMore: true,
  //   moreSelec:'.column-msg-box .column-more',
