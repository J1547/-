...
<html lang="zh-CN">
  ...
  <head>
    ...
    <link href="<?php bloginfo('template_directory'); ?>/css/common-mob.css" type="text/css" rel="stylesheet" />
    <!-- 主页 -->
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/index-mob.css">
